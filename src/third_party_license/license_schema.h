...
#ifndef __LICENSE_SCHEMA_H__
#define __LICENSE_SCHEMA_H__
...
class ThirdPartyLicenseSchema : public QcDatabaseSchema
{
public:
  ThirdPartyLicenseSchema(QcDatabase & database);
  ThirdPartyLicenseSchema(const ThirdPartyLicenseSchema & other) = delete;
  ~ThirdPartyLicenseSchema();

  ThirdPartyLicenseSchema & operator=(const ThirdPartyLicenseSchema & other) = delete;
