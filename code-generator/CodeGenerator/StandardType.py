...
class IsoDateTime(DateTime):
    ...
    __type_conversion__ = TypeConversion(
        ...
        cast_from_sql = 'json_helper::load_sql_datetime',
        cast_to_sql = 'json_helper::dump_sql_datetime'
    )
...
class UnixDateTime(FieldType):
    ...
    __type_conversion__ = TypeConversion(
        ...
        cast_from_json = 'json_helper::load_datetime',
        cast_to_json = 'json_helper::dump_datetime',
        cast_from_sql = 'json_helper::load_sql_datetime_as_epoch',
        cast_to_sql = 'json_helper::dump_sql_datetime_as_epoch'
    )
